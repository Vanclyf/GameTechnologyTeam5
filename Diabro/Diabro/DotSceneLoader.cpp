...
void DotSceneLoader::processScene(tinyxml2::XMLElement *XMLRoot)
{
...
void DotSceneLoader::processNodes(tinyxml2::XMLElement *XMLNode)
{
	tinyxml2::XMLElement *pElement;
...
void DotSceneLoader::processExternals(tinyxml2::XMLElement *XMLNode)
{
	//! @todo Implement this
}

void DotSceneLoader::processEnvironment(tinyxml2::XMLElement *XMLNode)
{
	tinyxml2::XMLElement *pElement;
...
void DotSceneLoader::processTerrain(tinyxml2::XMLElement *XMLNode)
{
	//! @todo Implement this
}

void DotSceneLoader::processUserDataReference(tinyxml2::XMLElement *XMLNode, SceneNode *pParent)
{
	//! @todo Implement this
}

void DotSceneLoader::processOctree(tinyxml2::XMLElement *XMLNode)
{
	//! @todo Implement this
}

void DotSceneLoader::processLight(tinyxml2::XMLElement *XMLNode, SceneNode *pParent)
{
	// Process attributes
...
void DotSceneLoader::processCamera(tinyxml2::XMLElement *XMLNode, SceneNode *pParent)
{
	// Process attributes
	String name = getAttrib(XMLNode, "name");
	String id = getAttrib(XMLNode, "id");
...
void DotSceneLoader::processNode(tinyxml2::XMLElement *XMLNode, SceneNode *pParent)
{
	...
	Ogre::SceneNode* node = GameManager::getSingletonPtr()->getSceneManager()->getSceneNode(name);
	...
	while (pElement)
	{
		GameManager::getSingletonPtr()->nodeOfSceneXML = name;
...
void DotSceneLoader::processLookTarget(tinyxml2::XMLElement *XMLNode, SceneNode *pParent)
{
...
void DotSceneLoader::processTrackTarget(tinyxml2::XMLElement *XMLNode, SceneNode *pParent)
{
	// Process attributes
	String nodeName = getAttrib(XMLNode, "nodeName");
...
void DotSceneLoader::processEntity(tinyxml2::XMLElement *XMLNode, SceneNode *pParent)
{
	// Process attributes
	String name = getAttrib(XMLNode, "name");
	String id = getAttrib(XMLNode, "id");
...
void DotSceneLoader::processParticleSystem(tinyxml2::XMLElement *XMLNode, SceneNode *pParent)
{
	// Process attributes
	String name = getAttrib(XMLNode, "name");
	String id = getAttrib(XMLNode, "id");
...
void DotSceneLoader::processBillboardSet(tinyxml2::XMLElement *XMLNode, SceneNode *pParent)
{
	//! @todo Implement this
}

void DotSceneLoader::processPlane(tinyxml2::XMLElement *XMLNode, SceneNode *pParent)
{
	//! @todo Implement this
}

void DotSceneLoader::processFog(tinyxml2::XMLElement *XMLNode)
{
	// Process attributes
...
void DotSceneLoader::processSkyBox(tinyxml2::XMLElement *XMLNode)
{
	// Process attributes
...
void DotSceneLoader::processSkyDome(tinyxml2::XMLElement *XMLNode)
{
	// Process attributes
...
void DotSceneLoader::processSkyPlane(tinyxml2::XMLElement *XMLNode)
{
	// Process attributes
	String material = getAttrib(XMLNode, "material");
...
void DotSceneLoader::processClipping(tinyxml2::XMLElement *XMLNode)
{
	//! @todo Implement this
...
void DotSceneLoader::processLightRange(tinyxml2::XMLElement *XMLNode, Light *pLight)
{
	// Process attributes
...
void DotSceneLoader::processLightAttenuation(tinyxml2::XMLElement *XMLNode, Light *pLight)
{
	// Process attributes
...
String DotSceneLoader::getAttrib(tinyxml2::XMLElement *XMLNode, const char* attrib, const char* defaultValue)
{
...
Real DotSceneLoader::getAttribReal(tinyxml2::XMLElement *XMLNode, const char* attrib, Real defaultValue)
{
	if (XMLNode->Attribute(attrib))
...
bool DotSceneLoader::getAttribBool(tinyxml2::XMLElement *XMLNode, const char* attrib, bool defaultValue)
{
	if (!XMLNode->Attribute(attrib))
		return defaultValue;
...
Vector3 DotSceneLoader::parseVector3(tinyxml2::XMLElement *XMLNode)
{
	return Vector3(
...
Quaternion DotSceneLoader::parseQuaternion(tinyxml2::XMLElement *XMLNode)
{
	//! @todo Fix this crap!
...
ColourValue DotSceneLoader::parseColour(tinyxml2::XMLElement *XMLNode)
{
	return ColourValue(
...
void DotSceneLoader::processUserDataReference(tinyxml2::XMLElement *XMLNode, Entity *pEntity)
{
